...
Get-Process | Sort-Object -Property WorkingSet64 -Descending | Select-Object -First 20 ProcessName, Id, CPU, @{Name = 'WS(MB)'; Expression = {[math]::Round($_.WorkingSet64/1MB, 2)}} |
