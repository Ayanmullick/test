...
#'{0:MMddyy:HHmmss} {1}' -f ($ct = [System.TimeZoneInfo]::ConvertTime([DateTimeOffset]::UtcNow, [System.TimeZoneInfo]::FindSystemTimeZoneById("America/Chicago"))), ([System.TimeZoneInfo]::FindSystemTimeZoneById("America/Chicago").IsDaylightSavingTime($ct.DateTime) ? 'CDT' : 'CST')
